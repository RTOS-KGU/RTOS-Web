...
# ***Welcome to Applied Computing Systems (ACS) Lab***
...
{{</modal-text>}}
- {{<modal-text text="2024.11.04. Applied Sciences 논문 게재" id="62">}}
연구실 석사 연구생인  노원준, 문기렴 학생의 "SMS-Net: Bridging the gap between high accuracy and low computational cost in pose estimation" 논문이 Applied Sciences (Impact Factor: 2.7)에 최종 게재 확정되었습니다. 
{{</modal-text>}}
